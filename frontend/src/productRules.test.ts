...
const DICTIONARY: { rule: Rule; stem: string; why: string }[] = [
    ...
    { rule: 13, stem: 'буфер', why: 'наше слово; запас на случай по-русски — «подушка», у кармашка — «НЗ»' },
    // Одно слово — одна вещь (решение владельца 25.09, ANO-92): ANO-124 за один PR унесла
    // «подушку» в пять строк кармашка, и порог «Хотелок» с суммой кармашка звались одинаково.
    { rule: 13, stem: 'подушк', why: 'подушка — порог «Хотелок» в месяцах расходов; у кармашка своё имя — «НЗ»' },
    // ANO-99: справка уже говорила «самый низкий остаток» (ANO-124), а фраза карточки
    // и расшифровка — «самый узкий день». Одна вещь под двумя именами на соседних экранах.
    { rule: 13, stem: 'узкий день', why: 'наше слово; у людей — «самый низкий остаток» (ANO-124)' },
    // ANO-76: над числом «В кармашке», а итог расшифровки того же числа — «Свободно» (ANO-77).
    // «Кармашек» в исследованиях писали только мы; «свободные деньги» знает каждый.
    { rule: 13, stem: 'кармаш', why: 'наше слово; у людей — «свободные деньги», на карточке — «Свободно»' },
];
