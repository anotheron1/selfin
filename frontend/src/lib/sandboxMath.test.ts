...
import {
    monthlyFor, monthsFor, refKey, sameRef, realizationScope, defaultTryOn,
} from './sandboxMath';
...
// lastDayOfMonth / stretchTargetDate уехали на сервер вместе с ANO-34 §1
// (SandboxLayoutStretchTargetDateTest хранит ровно эти случаи).
