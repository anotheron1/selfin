...
import { LayoutDashboard, CalendarDays, PiggyBank, BarChart2, Landmark, TrendingUp, Sparkles, Settings } from 'lucide-react';
...
const navItems = [
    ...
    { to: '/wishlist', icon: Sparkles, label: 'Хотелки' },
    { to: '/settings', icon: Settings, label: 'Настройки' },
];

/**
 * Фиксированная нижняя навигационная панель приложения.
 * Содержит 8 вкладок: Дашборд, Журнал, Цели, Аналитика, Капитал, Стратегия, Хотелки, Настройки.
