...
public class WishlistArtifactService {
    ...
    private void deleteFund(UUID fundId) {
        ...
        // Сознательно НЕ зовём TargetFundService.delete: он и есть ANO-86 — помечает копилку
        // удалённой, оставляя движения и событие перевода живыми, отчего деньги уходят из
        // свободных и продолжают раздувать капитал. Пока ANO-86 не починен, копилка с деньгами
        // отсюда не удаляется вовсе: лучше честный отказ, чем второй адрес того же дефекта.
