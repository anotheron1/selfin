...
## Замер на стенде (16.09.2026, схема V25, данные владельца)

Блок на дашборде, горизонт кармашка до 28.09:

```
ОСТАЛОСЬ ПОТРАТИТЬ                      82 100 ₽ до 28 сентября
раньше по плану
  Коммуналка                 4 000 ₽   записать
  Продукты                   8 000 ₽   записать
  Продукты                   8 000 ₽   записать
  Продукты                   8 000 ₽   записать
  Услуги людские · Стрижка   2 000 ₽   записать
21 сентября
  Ипотека                   23 600 ₽   записать
  Авто · Бензин              4 000 ₽   записать
  Досуг · Бассейн            4 500 ₽   записать
  Продукты                   8 000 ₽   записать
28 сентября
  Авто · Бензин              4 000 ₽   записать
  Продукты                   8 000 ₽   записать
...
Одиннадцать строк: пять «раньше по плану» на 30 000 и шесть впереди на 52 100. Ни одного слова-приговора, ни одной полоски.

**Запись факта из строки.** Нажал «записать» у «Коммуналки», сумма 4 000:

| | до | после |
|---|---|---|
| сумма блока | 82 100 | **78 100** |
| строк в списке | 11 | **10** |
| кармашек | −10 100 | **−10 100** |
| «Сегодня» | пусто | **Коммуналка ✓ −4 000** |

Кармашек не сдвинулся — и это верно: деньги ушли со счёта и ровно на столько же освободилась бронь. Ровно правило ANO-155, увиденное на экране.

Стенд возвращён в исходное: факт удалён, план снова `PLANNED`, кармашек −10 100.

**«Аналитика» после переезда** открывается так:

```
Месяц | 3 мес | 6 мес | 12 мес
Как прошёл месяц                            посмотреть
```

Ни отчёта план-факт, ни прогресс-баров в состоянии по умолчанию — ANO-122 закрыта.

## Что нашлось сверх плана

**Отчёт на «Аналитике» был не один.** Свернув план-факт, я увидел на его месте «СТРУКТУРУ МЕСЯЦА» — с «сэкономил 61 600 ₽», «Перерасход: 9 000 ₽», «0 из 5 выполнена» и подписью «900000% бюджета». Тот же разбор прошлого с теми же приговорами, и он остался бы встречать человека вместо свёрнутого. Убран под то же раскрытие; про «900000%» и формулировки заведена [ANO-165](https://linear.app/anotherspace1/issue/ANO-165).

**Сырой запрос к базе не равен списку блока.** Первая редакция спеки утверждала «семь строк на 72 100» — число снималось SQL-запросом без фильтров движка. Оно включало отклонённую хотелку (DISMISSED, 20 000), которую кармашек не держит, и не включало просрочку, которую держит. Настоящий состав виден только после сборки. Поправка внесена в спеку.

**Отклонённая хотелка в списке не появляется** — проверено на стенде: «Из примерки» со статусом DISMISSED отсутствует, потому что фильтр траектории пропускает только FIXED-неконвертированные. Отдельного правила для блока не понадобилось.
