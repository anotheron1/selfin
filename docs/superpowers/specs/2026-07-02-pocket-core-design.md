...
| `FIXED`, `converted=false`, дата есть | входит в траекторию как плановый расход — консистентно с наложением FIXED на /strategy timeline: решение принято, деньги заняты |
