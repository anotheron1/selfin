...
`horizon.label` — фиксированные шаблоны без категорийных эвристик (никакой детекции «зарплаты»): NEXT_INCOME → «до дохода 15.07»; фолбэк → «30 дней вперёд (нет плановых доходов)»; MONTHS:3 → «3 месяца (до 02.10)»; DATE → «до 01.03.2027».
